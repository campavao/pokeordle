...
import { EVOLUTION_STAGES, FILTER_TYPES, GENERATIONS } from '../constants';
              ...
              <div className="bst">
                <button
                  ...
                  className={`type-list-item bst-type ${
                    filterState.bstMod === 20 ? 'correct-type' : 'absent-type'
                  }`}
                >
                  +/- 20
                </button>
                <button
                  ...
                  className={`type-list-item bst-type ${
                    filterState.bstMod === 100 ? 'correct-type' : 'absent-type'
                  }`}
                >
                  +/- 100
                </button>
    ...
    const newFilterState = {
      ...
      [key]: {
        [filterType]: previousFilter.includes(value)
          ? previousFilter.filter((filterType) => filterType !== value)
    ...
    <div className="type-filter">
      ...
      <Modal show={filterKey} onHide={() => setFilterKey(undefined)}>
        <ListComponent
          ...
          list={options}
          include={options}
          disabled={filterKey === 'include' ? excludeList : includeList}
          exclude={filterKey === 'include' ? excludeList : includeList}
        />
      </Modal>
    </div>
  );
