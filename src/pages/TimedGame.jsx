...
function TimedGame() {
  ...
  useEffect(() => {
    async function addToLeaderboard() {
      ...
      const rawEntries = await getDocs(collection(db, 'timed_leaderboard'));
        ...
        : start && (
            <div className="game-reveal">
              <p>
                ...
                <strong>
                  {completedList.filter((poke) => !poke.isCorrect).length}
                </strong>
              </p>
              <p>
              ...
              {localStorage.getItem('username') === '' && (
                <p>Set a username above to keep track of your score!</p>
              )}
              <button
