  ...
  return (
    <Modal show={show} onHide={close} scrollable={true}>
      ...
      <Modal.Body>
        ...
        <div>
          Guess the Pokemon by matching types, generation, and/or stats!
          <br />
          <br />
          After each guess, the type(s)/generation/stats will change colors to
          show how close your guess was to the correct Pokemon.
        </div>
        <br />
        <div>
          ...
          <br />
          <em>
            Generation refers to the Generation where a Pokemon was introduced.
            Pikachu = Gen 1, Mudkip = Gen 3, etc.
          </em>
          <br />
          <br />
          <div>
        ...
        <div>
          ...
          <br />
          <em>
            Types refers to a Pokemon's type(s). Some have only one, while
            others have two.
          </em>
          <br />
          <br />
          ...
          <div>Here GRASS is in the right position, but POISON is not.</div>
          <br />
          <br />
          <div style={{ display: 'flex' }}>
          ...
          <div>
            Here FLYING is present in the Pokemon, but not in the right
            position.
          </div>
          <br />
          <br />
          ...
          <div>Here the guess had only one type while the Pokemon has two.</div>
          <br />
          <br />
          <div style={{ display: 'flex' }}>
          ...
          <div>Here the guess AND the Pokemon only have one type.</div>
          <br />
          <br />
          <div>
            ...
            <br />
            <em>
              Base stat total refers to a Pokemon's combined base stats: HP,
            ...
            <div>
              ...
              <div>
                Here 405 is within 20 points, but less than the actual Base Stat
                Total.
              </div>
              <br />
            </div>
            <div>
              ...
              <div>
                Here 275 is within 100 points, but less than the actual Base
                Stat Total.
              </div>
              <br />
            </div>
            <div>
              ...
              <div>
                Here 600 is not within 100 points, and is more than the actual
                Base Stat Total.
              </div>
            </div>
          </div>
